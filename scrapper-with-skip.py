...
def scrape_directory_content(root_dir, output_file_path):
    ...
    # Define a set of common binary file extensions to ignore.
    binary_extensions = {
        # Images
                ...
                if filenames:
                    ...
                    for filename in filenames:
                        ...
                        try:
                            ...
                            # The 'errors='ignore'' flag will prevent crashes on files that
                            # are not pure text but don't have a binary extension.
